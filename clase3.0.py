...
admin1 = Administrador("admin123", "segura123")
print(admin1.iniciar_sesion("admin123", "segura123"))
admin1.gestionar_usuarios()

cliente1 = Cliente("clienteXYZ", "compra2024")
print(cliente1.iniciar_sesion("clienteXYZ", "compra2024"))
